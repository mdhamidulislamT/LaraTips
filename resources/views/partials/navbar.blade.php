            ...
            <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                ...
                <li class="nav-item dropdown">
                    ...
                    <ul class="dropdown-menu" aria-labelledby="navbarDropdown">
                        <li><a class="nav-link" href="{{ route('admin.middleware1') }}"> middleware  & component</a></li>
                        <li><a class="nav-link" href="{{ route('admin.middleware2') }}"> Group middleware & component </a>
                        </li>
                    </ul>
                </li>
                <li class="nav-item">
