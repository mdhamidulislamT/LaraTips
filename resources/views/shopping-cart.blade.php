...
@section('title', 'shoppingcart pivot')
...
@section('content')
    ...
    <div class="row">
        <div class="col-md-12 text-center">
            <h1>Shopping Cart (pivot table)</h1>
        </div>
        <div class="col-md-12">
            <form id="productForm">
                @csrf
                <div class="row">
                    ...
                    <div class="col-md-4 my-3">
                        ...
                        <select class="form-select" id="product" name="product" onchange="addToCart(this.value)">
...
@section('javascripts')
    ...
    <script>
        ...
        function getCategoryWiseProducts(categoryId) {
            $.ajax({
                url: "{{ route('shoppingcart.getCategoryWiseProducts') }}",
                method: "GET",
                data: {
                    "id": categoryId
                },
